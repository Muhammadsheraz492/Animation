  ...
  Circle: {
    ...
    marginBottom:30
      ...
      {/* <Image
       ...
       {TabBtn(currentTab,setCurrentTab,"Home",Home)}
       {TabBtn(currentTab,setCurrentTab,"Search",Search)}
       {TabBtn(currentTab,setCurrentTab,"Notification",Notification)}
       {TabBtn(currentTab,setCurrentTab,"Settings",Settings)}
        </View>
        <View>
